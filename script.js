...
//Here we are  adding table header cells
...
function changeBgColor(row) {
  ...
  //Here we are writing the else part to make sure that everything goes back to normal on deselecting the row
  else {
...
function addStudentRow() {
  ...
  //Creating the Dropdown row of details and adding that to Table
...
//Deletion of rows on click of Delete button
...
function enableSubmit(){
  ...
  if(enableButton) {
    ...
    this.removeHeadings();
    //Here we are adding disabling styles to Submit Button if no rows are selected
