...
$(document).ready(function () {
    ...
    $("#username").html("Hello " + greetingValue + "!");
    ...
    function validatet1() {
      ...
      if (t1Value.length == "") {
        ...
        $("#txtNo1check").show();
        $("#txtNo1check").html("Please Enter a Valid Number.Give Only Numbers as Inputs");
        tError = false;
        return false;
      } else {
        $("#txtNo1check").hide();
    ...
    function validatet2() {
      ...
      if (t2Value.length == "") {
        ...
        $("#txtNo2check").show();
        $("#txtNo2check").html("Please Enter a Valid Number.Give Only Numbers as Inputs");
        t2Error = false;
        return false;
      } else {
        $("#txtNo2check").hide();
